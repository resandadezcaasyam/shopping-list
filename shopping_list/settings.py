...
SECRET_KEY = 'django-insecure-_d%*hx*xv7+kkyzjdk3#!nn!ir(!xryloi=#qe&8a(ld!8-k&)'
...
INSTALLED_APPS = [
    ...
    'authentication', # Tambahkan kode berikut
    'corsheaders', # Tambahkan kode berikut
    'main',
]
...
CORS_ALLOW_CREDENTIALS = True # Tambahkan kode berikut
